...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		vertices[3] = (int(vertices[3] * 255) + sign) / 255.0;
		vertices[10] = (int(vertices[10] * 255) + sign) / 255.0;
		vertices[17] = (int(vertices[10] * 255) + sign) / 255.0;
		if (vertices[3] >= 2.5 || vertices[3] <= 0)
		{
			sign = -1 * sign;
		}
